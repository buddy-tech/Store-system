...
{
    public partial class FRM_AllCOM_notyetfinishTheyMoney : Form
    {
        BL.CSL_load_allORERS cls = new BL.CSL_load_allORERS();
        bool chare = true;
        public string Order_ID;
        public FRM_AllCOM_notyetfinishTheyMoney()
        {
            InitializeComponent();
            load_all_Orders();
        ...
        {  
            ...
            ds = cls.LOAD_ALL_Ordersnotyetpayed_COM_todgv();
        ...
        private void btn_searchORDER_Click(object sender, EventArgs e)
        {
                ...
                if (tb_customerName.Text != "")
                {
                    ...
                    dt = cls.SEARCH_AllORDERSnotyetpayed_COM(tb_customerName.Text, Convert.ToDateTime(dateTimePicker2.Text), Convert.ToDateTime(dateTimePicker1.Text));
