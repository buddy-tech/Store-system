...
{
    public partial class FRM_Sin_COMorders : Form
    {
        ...
        {  
            DataTable ds = new DataTable();
                ds = cls.LOAD_ALL_OrdersCOM_todgv();
        ...
        private void btn_searchORDER_Click(object sender, EventArgs e)
        {
            radioButton1.Checked = false;
                if (tb_customerName.Text != "")
                {
                    ...
                    dt = cls.SEARCH_AllORDERS_COM(tb_customerName.Text, Convert.ToDateTime(dateTimePicker2.Text), Convert.ToDateTime(dateTimePicker1.Text));
